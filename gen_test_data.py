...
person2 = Person(name="Sergei aka 'Platon' aka 'Beard'", surname="Distriyanov")
db.session.add(person2)
person3 = Person(name="Vitalii", surname="Melnik")
db.session.add(person3)
person4 = Person(name="Ihor aka 'INgW4R'", surname="Dobrovolskyi")
db.session.add(person4)
person5= Person(name="Maxim", surname="Voronko")
db.session.add(person5)
person6= Person(name="Alex aka 'Travis'", surname="")
